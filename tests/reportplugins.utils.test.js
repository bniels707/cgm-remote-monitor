...
describe('report utils plugin', function ( ) {
  ...
  describe('localeDate', function ( ) {
    it ('should localize a day in the UTC timezone', function () {
      ...
      window.Nightscout = {'client': {'sbx': {'data': {'profile': {'getTimezone': mockGetTimezone}}}, 'translate': mockTranslate}};
      ...
      // Test with naive dayjs objects
      pluginUtils().localeDate(dayjs('1995-12-17')).should.equal('Sunday 12/17/1995');
      pluginUtils().localeDate(dayjs('1970-01-01')).should.equal('Thursday 1/1/1970');
      pluginUtils().localeDate(dayjs('2024-01-29')).should.equal('Monday 1/29/2024');
      pluginUtils().localeDate(dayjs('2023-10-28')).should.equal('Saturday 10/28/2023');
      pluginUtils().localeDate(dayjs('2015-09-01')).should.equal('Tuesday 9/1/2015');

      // Test with tz aware dayjs objects
      pluginUtils().localeDate(dayjs.tz('1995-12-17', process.env.TZ)).should.equal('Sunday 12/17/1995');
      pluginUtils().localeDate(dayjs.tz('1970-01-01', process.env.TZ)).should.equal('Thursday 1/1/1970');
      pluginUtils().localeDate(dayjs.tz('2024-01-29', process.env.TZ)).should.equal('Monday 1/29/2024');
      pluginUtils().localeDate(dayjs.tz('2023-10-28', process.env.TZ)).should.equal('Saturday 10/28/2023');
      pluginUtils().localeDate(dayjs.tz('2015-09-01', process.env.TZ)).should.equal('Tuesday 9/1/2015');
    ...
    it ('should apply a positive timezone offset from the profile to non-string days', function () {
      ...
      // Test with naive dayjs objects
      pluginUtils().localeDate(dayjs('1995-12-17T00:00:00')).should.equal('Sunday 12/17/1995');
      pluginUtils().localeDate(dayjs('1970-01-01T00:00:00')).should.equal('Thursday 1/1/1970');
      pluginUtils().localeDate(dayjs('2024-01-29T00:00:00')).should.equal('Monday 1/29/2024');
      pluginUtils().localeDate(dayjs('2023-10-28T00:00:00')).should.equal('Saturday 10/28/2023');
      pluginUtils().localeDate(dayjs('2015-09-01T00:00:00')).should.equal('Tuesday 9/1/2015');

      // Test with tz aware dayjs where the date should change
      pluginUtils().localeDate(dayjs.tz('1995-12-17T00:00:00', testTimezone)).should.equal('Saturday 12/16/1995');
      pluginUtils().localeDate(dayjs.tz('1970-01-01T00:00:00', testTimezone)).should.equal('Wednesday 12/31/1969');
      pluginUtils().localeDate(dayjs.tz('2024-01-29T00:00:00', testTimezone)).should.equal('Sunday 1/28/2024');
      pluginUtils().localeDate(dayjs.tz('2023-10-28T00:00:00', testTimezone)).should.equal('Friday 10/27/2023');
      pluginUtils().localeDate(dayjs.tz('2015-09-01T00:00:00', testTimezone)).should.equal('Monday 8/31/2015');
    ...
    it ('should apply a negative timezone offset from the profile to non-string days', function () {
      ...
      // Test with naive dayjs objects
      pluginUtils().localeDate(dayjs('1995-12-17T23:00:00')).should.equal('Sunday 12/17/1995');
      pluginUtils().localeDate(dayjs('1970-01-01T23:00:00')).should.equal('Thursday 1/1/1970');
      pluginUtils().localeDate(dayjs('2024-01-29T23:00:00')).should.equal('Monday 1/29/2024');
      pluginUtils().localeDate(dayjs('2023-10-28T23:00:00')).should.equal('Saturday 10/28/2023');
      pluginUtils().localeDate(dayjs('2015-09-01T23:00:00')).should.equal('Tuesday 9/1/2015');

      // Test with tz aware dayjs where the date should change
      pluginUtils().localeDate(dayjs.tz('1995-12-17T23:00:00', testTimezone)).should.equal('Monday 12/18/1995');
      pluginUtils().localeDate(dayjs.tz('1970-01-01T23:00:00', testTimezone)).should.equal('Friday 1/2/1970');
      pluginUtils().localeDate(dayjs.tz('2024-01-29T23:00:00', testTimezone)).should.equal('Tuesday 1/30/2024');
      pluginUtils().localeDate(dayjs.tz('2023-10-28T23:00:00', testTimezone)).should.equal('Sunday 10/29/2023');
      pluginUtils().localeDate(dayjs.tz('2015-09-01T23:00:00', testTimezone)).should.equal('Wednesday 9/2/2015');
    ...
    it ('should localize a day in any timezone', function () {
      ...
      pluginUtils().localeDate(dayjs('2021-02-06')).should.equal('Saturday 2/6/2021');
      pluginUtils().localeDate(dayjs.tz('2021-02-06', process.env.TZ)).should.equal('Saturday 2/6/2021');
      ...
      pluginUtils().localeDate(dayjs('1995-09-24')).should.equal('Sunday 9/24/1995');
      pluginUtils().localeDate(dayjs.tz('1995-09-24', process.env.TZ)).should.equal('Sunday 9/24/1995');
  ...
  describe('localeDateTime', function ( ) {
    it ('should localize a datetime in the UTC timezone', function () {
      ...
      // Test with naive dayjs objects
      pluginUtils().localeDateTime(dayjs('1995-12-17')).should.equal('12/17/1995 12:00:00 AM');
      pluginUtils().localeDateTime(dayjs(628021800000)).should.equal('11/25/1989 6:30:00 PM');
      pluginUtils().localeDateTime(dayjs('2024-01-29')).should.equal('1/29/2024 12:00:00 AM');

      // Test with tz aware dayjs objects
      pluginUtils().localeDateTime(dayjs.tz('1995-12-17', process.env.TZ)).should.equal('12/17/1995 12:00:00 AM');
      pluginUtils().localeDateTime(dayjs.tz(628021800000, process.env.TZ)).should.equal('11/25/1989 6:30:00 PM');
      pluginUtils().localeDateTime(dayjs.tz('2024-01-29', process.env.TZ)).should.equal('1/29/2024 12:00:00 AM');
    ...
    it ('should apply a positive offset timezone offset from the profile to non-string datetimes', function () {
      ...
      // Test with naive dayjs objects
      pluginUtils().localeDateTime(dayjs('1995-12-17T00:00:00')).should.equal('12/17/1995 12:00:00 AM');
      pluginUtils().localeDateTime(dayjs(628021800000)).should.equal('11/25/1989 6:30:00 PM');
      pluginUtils().localeDateTime(dayjs('2024-01-29T00:00:00')).should.equal('1/29/2024 12:00:00 AM');

      // Test with tz aware dayjs where the date should change
      pluginUtils().localeDateTime(dayjs.tz('1995-12-17T00:00:00', testTimezone)).should.equal('12/16/1995 6:00:00 PM');
      pluginUtils().localeDateTime(dayjs.tz('2024-01-29T00:00:00', testTimezone)).should.equal('1/28/2024 6:00:00 PM');
    ...
    it ('should apply a negative offset timezone offset from the profile to non-string datetimes', function () {
      ...
      // Test with naive dayjs objects
      pluginUtils().localeDateTime(dayjs('1995-12-17T23:00:00')).should.equal('12/17/1995 11:00:00 PM');
      pluginUtils().localeDateTime(dayjs(628021800000)).should.equal('11/25/1989 6:30:00 PM');
      pluginUtils().localeDateTime(dayjs('2024-01-29T23:00:00')).should.equal('1/29/2024 11:00:00 PM');

      // Test with tz aware dayjs where the date should change
      pluginUtils().localeDateTime(dayjs.tz('1995-12-17T23:00:00', testTimezone)).should.equal('12/18/1995 5:00:00 AM');
      pluginUtils().localeDateTime(dayjs.tz('2024-01-29T23:00:00', testTimezone)).should.equal('1/30/2024 5:00:00 AM');
